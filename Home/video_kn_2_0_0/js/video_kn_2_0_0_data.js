const video_kn_2_0_0_data = [
    {
        ...
        item: [
            ...
            },
            {
                ...
                alt: 'Hành Trình Lột Xác mùa 6 | Tập 2: Trần Thị Xuân Mai – Cô bé vương miện sắt',
            },
            {
                season: 'Mùa 6',
                episode: 'Tập 1',
                ...
                alt: 'Hành Trình Lột Xác mùa 6 | Tập 1 Ninh Thị Thu Hường – Cô gái mặt lõm',
            },
            {
                season: 'Mùa 5',
                episode: 'Tập 1',
        ...
        item: [
            {
                ...
                alt: 'Beauty Up | Tập 1: Ngọc Huyền - Vẫn là sự thật nhưng khuếch đại lên',
            },
            {
                season: 'Mùa 1',
                episode: 'Tập 2',
                link: 'https://www.youtube.com/watch?v=7syiXqDLfI8&list=PLROTewhS4-MYcFAX_cJVY9GWnrqHR5M8u&index=2',
                alt: 'Beauty Up | Tập 2: Phương Anh - Những nốt bổng của nhan sắc',
            },
            {
                season: 'Mùa 1',
                episode: 'Tập 3',
                link: 'https://www.youtube.com/watch?v=iNUiO3V3Oz0&list=PLROTewhS4-MYcFAX_cJVY9GWnrqHR5M8u&index=3',
                alt: 'Beauty Up | Tập 3: Huy Ngọc - 40 tuổi trốn chồng đi thẩm mỹ và cái kết',
            },
        ]
    },
    {
        ...
        item: [
            {
                ...
                alt: 'Đinh Nho Liêm và câu chuyện cảm động về việc giải cứu mũi cong vẹo',
            },
            {
                season: 'Mùa 1',
                episode: 'Tập 2',
                link: 'https://www.youtube.com/watch?v=fCLVfMpUeR0&list=PLROTewhS4-MaQ8Fb6pseOa2Py_nNDQ1-R&index=2',
                alt: 'Tư vấn sửa mũi hỏng, gãy xương chính mũi lâu năm | Giải cứu mũi hỏng',
            },
            {
                season: 'Mùa 1',
                episode: 'Tập 3',
                link: 'https://www.youtube.com/watch?v=iCdaVXNX_ig&list=PLROTewhS4-MaQ8Fb6pseOa2Py_nNDQ1-R&index=3',
                alt: 'Sửa mũi hỏng, tụt sụn do tai nạn | Giải cứu mũi hỏng',
            },
        ]
    },
];
